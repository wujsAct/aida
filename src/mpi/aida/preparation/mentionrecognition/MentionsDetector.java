...
public class MentionsDetector implements Serializable {
  ...
  public MentionDetectionResults filter(String docId, String text, Tokenizer.type tokenizerType, MentionsDetector.type mentionDetectionType, PreparationSettings.LANGUAGE language) {
