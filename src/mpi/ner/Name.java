...
public class Name {
	...
	public Name(PosToken posToken) {
		this.name = posToken.getToken();
		this.start = posToken.getStart();
		this.length = posToken.getLength();
		this.score = posToken.getScore();
		this.nerAnnotatorId = posToken.getPosAnnotatorId();
	...
	public String toString() {
		return "Name [name=" + name + ", start=" + start + ", length=" + length
				+ ", score=" + score + ", nerAnnotatorId=" + nerAnnotatorId
				+ "]";
	}
